...
// 🛑 Obrigatório na Vercel para upload de arquivos funcionar
...
async function handler(req, res) {
    ...
    form.parse(req, async (err, fields, files) => {
        ...
        try {
            // 🛡️ Proteção Universal: Suporta Formidable v2 e v3, e nomes 'arquivo' ou 'file'
            ...
            // Pega o arquivo real independentemente de vir como Array (v3) ou Objeto (v2)
            ...
            // Lê o buffer do arquivo temporário gerado pelo Formidable
            ...
            // Se o erro for "Erro Python", deixamos isso claro
